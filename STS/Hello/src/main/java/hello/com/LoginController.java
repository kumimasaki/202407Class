...
public class LoginController {
	...
	/**
	 * htmlからデータを受け取るためのURL「/register/process」
	 * メソッド名：register
	 * 
	 * もし、usernameの内容が「user」
	 * かつ、emailの内容が「admin@test.com」
	 * かつ、passwordの内容が「admin」の場合、/resultに転送してください
	 * そうでない場合、/registerに転送してください
	 */
